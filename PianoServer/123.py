...
class MusicTransformer(nn.Module):
    ...
    def forward(self, src, tgt):
        ...
        output = self.transformer.decoder(tgt_embedded.transpose(0, 1), memory, tgt_mask=tgt_mask,
...
data_path = "C:\\Users\\steven6502\\Desktop\\unity-piano\\pianoroll"
...
# 初始化模型
model = MusicTransformer(vocab_size, d_model, nhead, num_encoder_layers, num_decoder_layers, dim_feedforward,
                         dropout).to(device)
